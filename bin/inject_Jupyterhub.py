...
def main():
    ...
    for file in all_files:
        ...
        if find_jupyter>0:
            ...
            sub1 = "lab/tree/avni-courses.introduction/bin/"
            sub2 = "&branch=main"
            ...
            if res.startswith('PS_') or res.startswith('Field_Trip_'):
                select['href'] = 'https://geodynamics.org/tools/avninotebooks/invoke?params='+urllib.parse.quote('file(notebook):/apps/avninotebooks/'+res,safe='')
            else:
                select['href'] = 'https://geodynamics.org/tools/avninotebooks/invoke?params='+urllib.parse.quote('file(notebook):/apps/avninotebooks/welcome.ipynb',safe='')                
